...
var daysPassed = tinhngay(t); // Hàm tinhngay đã có sẵn trong code của bạn
var currentSlots = initialSlots - Math.floor(daysPassed * 1.5); // Mỗi ngày giảm trung bình 1.5 suất
if (currentSlots < 2) currentSlots = 2; // Luôn giữ tối thiểu 2 suất để tạo động lực
