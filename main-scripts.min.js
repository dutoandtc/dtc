...
if (giamgia) {
    ...
    // 2. Tính số ngày đã trôi qua kể từ ngày đăng
    var daysPassed = tinhngay(t); 
    // 3. Công thức giảm dần (mỗi ngày giảm 1.5 suất)
    var currentSlots = initialSlots - Math.floor(daysPassed * 1.5); 
    if (currentSlots < 2) currentSlots = 2; // Luôn còn ít nhất 2 suất

    // 4. Tạo HTML hoàn chỉnh cho khung đếm ngược
